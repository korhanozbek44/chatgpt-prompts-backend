...
router.route('/').get(validate(promptValidation.getAll), promptsController.getAll);

router.route('/:promptId').get(validate(promptValidation.getOne), promptsController.getOne);
